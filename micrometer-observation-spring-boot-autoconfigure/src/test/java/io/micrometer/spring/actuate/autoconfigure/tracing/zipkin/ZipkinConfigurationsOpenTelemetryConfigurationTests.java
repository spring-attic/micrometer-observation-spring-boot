...
/**
 * Tests for {@link ZipkinConfigurations.OpenTelemetryConfiguration}.
 *
...
class ZipkinConfigurationsOpenTelemetryConfigurationTests {
	...
	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner().withConfiguration(
			AutoConfigurations.of(BaseConfiguration.class, ZipkinConfigurations.OpenTelemetryConfiguration.class));
