...
/**
 * Tests for {@link OpenTelemetryConfigurations.TracerConfiguration}.
 *
...
class OpenTelemetryConfigurationsTracerConfigurationTests {
	...
	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
			.withConfiguration(AutoConfigurations.of(OpenTelemetryConfigurations.TracerConfiguration.class));
