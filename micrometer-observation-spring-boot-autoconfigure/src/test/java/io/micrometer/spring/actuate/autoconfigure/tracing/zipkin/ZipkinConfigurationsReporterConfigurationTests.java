...
/**
 * Tests for {@link ZipkinConfigurations.ReporterConfiguration}.
 *
...
class ZipkinConfigurationsReporterConfigurationTests {
	...
	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner().withConfiguration(
			AutoConfigurations.of(BaseConfiguration.class, ZipkinConfigurations.ReporterConfiguration.class));
